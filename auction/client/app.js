...
app.controller('appController',function($scope, appFactory){
    ...
    $scope.query_qGetUser_100 = function(){
        //console.log(y+"-"+mon+"-"+d+" "+h+':'+min+':'+s);
        console.log("into query_qGetUser_100");
        //var id = $scope.alo_UserID;
        
        appFactory.query_qGetUser_100(function(data){
            $scope.query_qGetUser_100 = data;
            console.log("I'm in appController query "+ data);
            if($scope.query_qGetUser_100 == "Could not locate User"){
                console.log()
                $("error_query").show();
            }else{
                $("#error_query").hide();
    ...
    $scope.invoke_iPostUser_100 = function(){
        console.log("into invoke_iPostUser_100");
        appFactory.invoke_iPostUser_100(function(data){
            $scope.invoke_iPostUser_100 = data;
            console.log("I'm in appController Post "+ data);
            $("#success_create").show();
        });
    }
...
app.factory('appFactory', function($http){
    ...
    factory.query_qGetUser_100 = function(callback){
        console.log("before factory query");
        $http.get('/GetUser_100/').success(function(output){
            console.log("I'm in factory query " + output);
           callback(output) 
        });
    ...
    factory.invoke_iPostUser_100 = function(callback){
        ...
        $http.get('/PostUser_100/'+TimeStamp).success(function(output){
            console.log("I'm in factory Post " + output);
            callback(output)
        });
    }
